        ...
        <table class="table mt-5">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php if (isset($_SESSION['acceso'])) { ?><a href="./?op=guardarreserva&idh=<?php echo $r->id ?>" class="btn text-white fw-bold" style="background-color: #003580;">Reservar habitacion</a><?php } else { ?>Inicie sesion para reservar<?php } ?></td>
                </tr>
                <?php } ?>
            </tbody>
        </table>
